...
import { springEntrance, springProgress, springHover, springTap, fadeUp } from "@/lib/motion-variants";
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="h-1.5 rounded-full bg-muted overflow-hidden">
                      <motion.div
                        ...
                        transition={{ ...springProgress, delay: i * 0.05 }}
                        style={{
                          backgroundColor:
            ...
            <div className="space-y-2">
              {profile.recentActivity.map((act, i) => (
                <motion.div
                  ...
                  transition={{ ...springEntrance, delay: i * 0.03 }}
...
function ProfileStatCard({
  ...
  return (
    <motion.div
      whileHover={{ y: -1, transition: springHover }}
